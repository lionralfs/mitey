...
class API {
   ...
   * @return {Object}             The completed request options
   * @private
   */
   ...
   * @param {String} method       HTTP method
   * @param {Object} [body]       The request body
   * @return {Promise}            The API-Response as a Promise
   * @private
   */
  ...
  /**
   * Stops the time tracker on the time entry with the 
   * given id and returns its last state.
   ...
   * The entry can belong to any user of the account,
   ...
   *
   * @param {String} [name]   Filters the list by name. The given string will 
   *                          match partly and is treated as
   *                          case-insensitive.
   * @return {Promise}        The API-Response as a Promise
   */
  getCustomers({name}) {
   ...
   *
   * @param {String} [name]   Filters the list by name. The given string will
   *                          match partly and is treated as case-insensitive.
   * @param {Number} [id]     Filters the list by customer. Can be either 
   *                          a single ID, or multiple comma-separated IDs.
   * @return {Promise}        The API-Response as a Promise
   */
  getProjects({name, id}) {
    let paramString = '';
   ...
   * @see https://mite.yo.lk/en/api/time-entries.html#list-daily
   *
   * @return {Promise}        The API-Response as a Promise
   */
  getToday() {
